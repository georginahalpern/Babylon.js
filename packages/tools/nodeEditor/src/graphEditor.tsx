...
type IGraphEditorPropsInner = IGraphEditorProps & {
    styles: any;
};
...
export class GraphEditorInner extends React.Component<IGraphEditorPropsInner, IGraphEditorState> {
    ...
    constructor(props: IGraphEditorPropsInner) {
        super(props);
...
export const GraphEditor = (props: IGraphEditorProps) => {
    const styles = useGlobalStyles();
    return <GraphEditorInner {...props} styles={styles} />;
};
