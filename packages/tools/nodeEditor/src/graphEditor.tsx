...
import { StyledToolHost } from "shared-ui-components/fluent/toolHost";
import { StyledPreviewPanel } from "shared-ui-components/fluent/styledWrappers";
    ...
    override render() {
        return (
            <Portal globalState={this.props.globalState}>
                <StyledToolHost>
                    {
                        // NOTE We can send in NME specific theme for coloring etc
                    }
                    <SplitContainer
                    ...
                    >
                        ...
                        {/* Property tab */}
                        {
                            // NOTE that in second refactor i will de-duping this logic w the other graph editors, just trying to scope PR
                        }
