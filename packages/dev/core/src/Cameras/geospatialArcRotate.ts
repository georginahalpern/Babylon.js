 ...
 */
export class GeospatialArcRotate extends ArcRotateCamera {
    ...
    constructor(name: string, target: Vector3, scene: Scene, setActiveOnSceneIfNoneActive?: boolean) {
        super(name, 0, 1, RADIUS * 3, target, scene, setActiveOnSceneIfNoneActive);
...
RegisterClass("GeospatialArcRotate", GeospatialArcRotate);
