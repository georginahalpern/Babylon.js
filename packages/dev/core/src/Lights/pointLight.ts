...
export class PointLight extends ShadowLight {
    ...
    public transferToEffect(effect: Effect, lightIndex: string): PointLight {
        ...
        if (this.computeTransformedInformation()) {
            this._uniformBuffer.updateFloat4Offset(
                "vLightData",
            ...
            this._uniformBuffer.updateFloat4Offset("vLightData", this.position.x, this.position.y, this.position.z, 0, lightIndex, this._scene.floatingOriginOffset);
        }
